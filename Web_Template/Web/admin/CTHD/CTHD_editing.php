    ...
    <div class="main-content">
        ...
        <div id="content-box">
            ...
            if (isset($_GET['action']) && $_GET['action'] == 'add') {
                if (!empty($_POST['MaMH']) && !empty($_POST['DonGia']) && !empty($_POST['ThanhTien'])) {
                    if (empty($_POST['MaHD'])) {
                    ...
                    if (!isset($error)) {
                        $result = $ql_quanaonam->updateCTHoaDon($_POST['MaHD'],$_POST['MaMH'],$_POST['SoLuong'],$_POST['DonGia'],$_POST['ThanhTien']);
                        if (!$result) {
