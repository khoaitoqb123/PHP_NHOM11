    ...
    <div class="main-content">
        ...
        <div id="content-box">
            ...
            if (isset($_GET['action']) && $_GET['action'] == 'add') {
                if (isset($_POST['MaMH']) && !empty($_POST['TenMH']) && isset($_POST['MaLH']) && !empty($_POST['Soluong']) && !empty($_POST['GiaBan']) && !empty($_POST['Anh'])) {
                    $galleryImages = array();
                    if (empty($_POST['MaMH'])) {
                        $error = "Bạn phải nhập mã mặt hàng";
                    } elseif (empty($_POST['TenMH'])) {
                    ...
                    if (!isset($error)) {
                        $result = $ql_quanaonam->insertMatHang($_POST['MaMH'],$_POST['TenMH'],$_POST['MaLH'],$_POST['Soluong'],$_POST['GiaBan'],$_POST['Anh']);
                        if (!$result) {
