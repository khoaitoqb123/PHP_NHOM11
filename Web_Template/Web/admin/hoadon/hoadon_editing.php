    ...
    <div class="main-content">
        ...
        <div id="content-box">
            ...
            if (isset($_GET['action']) && $_GET['action'] == 'add') {
                if (!empty($_POST['MaHD']) && !empty($_POST['MaNV']) && !empty($_POST['NgayBan']) && !empty($_POST['MaKH'])) {
                    if (empty($_POST['MaHD'])) {
                    ...
                    if (!isset($error)) {
                        $result = $ql_quanaonam->updateHoaDon($_POST['MaHD'],$_POST['MaNV'],$_POST['NgayBan'],$_POST['MaKH']);
                        if (!$result) {
